...
class PhoneAndTablet extends Component {
            ...
            <div className="market-content">
                <div className="container">
                    <div className="breadcrumb">
                        ...
                        <Breadcrumb>
                            ...
                            <BreadcrumbItem className='bread-2'>
                                <Link to=''>Phone & Tablet</Link>
                            </BreadcrumbItem>
                        </Breadcrumb>
                    </div>

                    {/* PAGE HEADING */}
                    <div className="page-heading text-center p-2 mb-4">Phones & Tablet</div>

                    {/* LIMITED STOCK DEALS */}
                    <div className="blockbuster-2 mb-4 pb-2">
                        <p className='sub-heading p-2'>Limited Stock Deals</p>
                        <div className="blockbuster-content">
                            {product.map(item => {
                                if (item.sale_type === 'Limited Stock' && (item.category === 'Tablet' || item.category === 'Phone')) {
                                    return (
                                        <div key={item.id}>
                    ...
                    <div className="blockbuster-2 mb-4 pb-2">
                        ...
                        <div className="blockbuster-content">
                            {product.map(item => {
                                if (item.sale_type === 'Top Deals' && (item.category === 'Tablet' || item.category === 'Phone')) {
                                    return (
                                        <div key={item.id}>
                                            <Link to={`/product/${item.id}`} className="blockbuster-item">
                                                <div className="img-container">
...
export default connect(mapStateToProps, mapDispatchToProps)(PhoneAndTablet);